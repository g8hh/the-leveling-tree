var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span style="font-size:25px" class="overlayThing">Level </span>
		<span style="font-size:34px" class="overlayThing" id="points">{{format(player.points.floor(), 0)}}</span>
		<div class="overlayThing">{{'(' + format(player.points.sub(player.points.floor()).times(100), 1) + '%)'}}</div>
