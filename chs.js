...
var cnRegReplace = new Map([
    ...
    [/^([\d\.]+)e([\d\.,]+) treasures$/, '$1e$2 珍宝'],
    [/^e([\d\.]+)e([\d\.,]+) treasures$/, 'e$1e$2 珍宝'],
    ...
    [/^Get (.+) skills$/, '获得 $1 技能'],
    [/^Get (.+) skill$/, '获得 $1 技能'],
    [/^Total treasures help you get more skills. Lol. Increases your max level by (.+). Increases your skill powered gain by (.+). Needs 60 really last (.+) quest challenge completions for treasure prestige.$/, '总计珍宝可以帮助你获得更多技能。Lol.使你的最高等级增加 $1。增加你的技能增益 $2。需要60次真正的最后 $3 任务挑战完成才能获得宝藏声望。'],
